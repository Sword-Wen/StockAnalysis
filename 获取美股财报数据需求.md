...
```bash
# 获取特定年份数据
python run_sec_financials.py fetch AAPL --year 2023

# 获取特定季度数据
python run_sec_financials.py fetch MSFT --year 2023 --quarter 4

# 获取年份范围数据
python run_sec_financials.py fetch GOOGL --start-year 2020 --end-year 2023

# 获取季度范围数据
python run_sec_financials.py fetch AMZN --start-year 2022 --start-quarter 1 --end-year 2023 --end-quarter 4

# 搜索股票代码
python run_sec_financials.py search AAP --limit 5

# 查看统计信息
python run_sec_financials.py stats

# 清除缓存
python run_sec_financials.py clear-cache
```
